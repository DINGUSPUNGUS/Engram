...
expected_output: >-
  JSON array of candidate objects: {"kind": one of the twelve memory kinds,
  ...
  existing entity id from the known-entities list}]}. Empty array when nothing
  qualifies.
...
- When nothing qualifies, return an empty array.
